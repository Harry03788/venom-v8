...
TOKEN = '7891871648:AAH24Bgn7zNVZYIz97u08CL0BvhgntEChFU'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [6009757222,6639988956,1589350320]
...
def show_id(message):
    ...
    bot_owner = "Harry_bgmi_bot"  # 👑 The bot owner's username  ⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner:'@harry_bgmi_bot'")
